...
from model_360.utils import log_normal_density
...
class CNNPolicy(nn.Module):
    def __init__(self, frames, action_space):
        ...
        self.act_fc1 = nn.Linear(270*32, 256)  # 需根据传入雷达的线数做修改
        # self.act_fc1 = nn.Linear(60*32, 256)  # 需根据传入雷达的线数做修改
        ...
        self.crt_fc1 = nn.Linear(270*32, 256)   # 需根据传入雷达的线数做修改
        # self.crt_fc1 = nn.Linear(60*32, 256)   # 需根据传入雷达的线数做修改
