...
if __name__ == '__main__':
    ...
    rank = 0
    env = StageWorld(fov=FOV, max_range=MAX_RANGE, out_lines=OUT_LINES, beam_num=LASER_BEAM, index=10, num_env=NUM_ENV)
    reward = None
    ...
    if rank == 0:
        ...
        file = policy_path + '/Stage360_320_3160_300_140_160.pth'
